...
//        let session = URLSession(configuration: config)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        // 선택된 셀이 ListTableViewCell 형식인지 확인합니다.
